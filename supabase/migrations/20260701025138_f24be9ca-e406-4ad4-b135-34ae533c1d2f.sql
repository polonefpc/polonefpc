REVOKE ALL ON FUNCTION public.request_package_change(uuid, integer, text) FROM PUBLIC, anon;
REVOKE ALL ON FUNCTION public.approve_package_change(uuid) FROM PUBLIC, anon;
REVOKE ALL ON FUNCTION public.reject_package_change(uuid, text) FROM PUBLIC, anon;
GRANT EXECUTE ON FUNCTION public.request_package_change(uuid, integer, text) TO authenticated;
GRANT EXECUTE ON FUNCTION public.approve_package_change(uuid) TO authenticated;
GRANT EXECUTE ON FUNCTION public.reject_package_change(uuid, text) TO authenticated;
